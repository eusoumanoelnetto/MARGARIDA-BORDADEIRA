...
const Hero: React.FC = () => {
  return (
    <section className="relative h-screen min-h-[600px] w-full overflow-hidden flex items-center justify-center bg-forest-900">
      ...
      {/* Content */}
      <div className="relative z-20 text-center px-5 sm:px-6 w-full max-w-7xl mx-auto flex flex-col items-center justify-center h-full pt-32 md:pt-36 pb-24">
        ...
        {/* Scroll Indicator */}
        <div className="mt-12 sm:mt-14 md:mt-12 lg:mt-16 flex justify-center">
          <a href="#gallery" className="flex flex-col items-center gap-2 text-linen/70 hover:text-white transition-colors cursor-pointer group animate-bounce duration-[2800ms]">
            ...
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full border border-linen/30 flex items-center justify-center backdrop-blur-sm group-hover:bg-rose-500/20 group-hover:border-rose-300 transition-all shadow-lg">
